...
title AcuarelaCRM - Servidor de desarrollo
...
REM Espera en segundo plano a que el puerto escuche y recien ahi abre el navegador.
REM No usamos --open de Vite porque Windows no resuelve *.localhost por DNS:
REM solo el navegador lo resuelve a 127.0.0.1 (RFC 6761).
